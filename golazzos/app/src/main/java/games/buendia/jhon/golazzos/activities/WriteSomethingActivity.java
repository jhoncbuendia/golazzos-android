...
import games.buendia.jhon.golazzos.fragments.WriteSomethingFragment;
 ...
 */
public class WriteSomethingActivity extends FragmentActivity implements BaseMethodsActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buildMenu(null);
        makeTransaction(new WriteSomethingFragment(), getSupportFragmentManager(), R.id.content_frame);
    }
    ...
    public void buildMenu(ListView listView) {
        ...
        findViewById(R.id.cardViewQuieroSerTitular).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(WriteSomethingActivity.this, MainActivity.class));
            }
        });
        ...
        listViewMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                if (position == 6){
                    ...
                    startActivity(new Intent(WriteSomethingActivity.this, SignInActivity.class));
                    finish();
                }
            }
        });
