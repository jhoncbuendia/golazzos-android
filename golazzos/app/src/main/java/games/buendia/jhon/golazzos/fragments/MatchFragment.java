...
public class MatchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tab1.setIndicator("Por jugar");    //qué queremos que aparezca en las pestañas
        tab1.setContent(R.id.jugar); //definimos el id de cada Tab (pestaña)

        tab2.setIndicator("En vivo");
        tab2.setContent(R.id.vivo);

        tab3.setIndicator("Finalizado");
        tab3.setContent(R.id.finalizado);
