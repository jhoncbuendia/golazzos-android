...
public class SignInActivity extends AppCompatActivity implements RequestInterface {
    ...
    public void loginrMailUser(String email, String pwd){
        ...
        try {
            user_data.put("from", "credentials");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ingresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                TextView user = (TextView) findViewById(R.id.userin);
                TextView pwd = (TextView) findViewById(R.id.pwdin);
                Log.i("user and pass", user.getText().toString() + pwd.getText().toString());
                loginrMailUser(user.getText().toString(), pwd.getText().toString());

            }
        });

        //SignInFragment l = new SignInFragment();
        //FragmentManager fragmentManager = getSupportFragmentManager();
        //fragmentManager.beginTransaction().add(R.id.signin_content, l, "signin").commit();
