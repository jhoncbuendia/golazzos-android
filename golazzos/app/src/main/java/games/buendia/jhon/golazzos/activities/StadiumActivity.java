 ...
 */
public class StadiumActivity extends FragmentActivity implements BaseMethodsActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buildMenu(null);
        makeTransaction(new StadiumFragment(), getSupportFragmentManager(), R.id.content_frame);
    }
